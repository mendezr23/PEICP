...
return [
    ...
    */
    ...
    'logo' => '<b>PE</b>ICP',
    'logo_img' => 'vendor/adminlte/dist/img/MirandaLogo.png',
    'logo_img_class' => 'brand-image img-circle elevation-3',
    'logo_img_xl' => null,
    'logo_img_xl_class' => 'brand-image-xs',
    'logo_img_alt' => 'Gobernacion de Miranda',
    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'active'=> ['admin/indicators*'],
            'can'    => ['admin.indicators.index']
        ],
        [
            'text' => 'Cuadrantes',
            'route'  => 'admin.quadrants.index',
            'icon' => 'fas fa-columns fa-fw',
            'active'=> ['admin/quadrants*'],
            'can' => ['admin.quadrants.index']
        ],
        
        [
            'text' => 'Tipos de Cuadrantes',
        ...
        [
            'text' => 'Organismos',
            'route'  => 'admin.organisms.index',
            'icon' => 'fas fa-archway fa-fw',
            'active'=> ['admin/organisms*'],
